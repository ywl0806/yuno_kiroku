...
type AlbumGroupPermissionStore interface {
	GetAlbumGroupPermissions(ctx context.Context, albumID int32) ([]db.AlbumGroupsPermission, error)
...
func (s *albumGroupPermissionStore) GetAlbumGroupPermissions(ctx context.Context, albumID int32) ([]db.AlbumGroupsPermission, error) {
	return wrapErr(s.queries.GetAlbumGroupPermissions(ctx, albumID))
}
